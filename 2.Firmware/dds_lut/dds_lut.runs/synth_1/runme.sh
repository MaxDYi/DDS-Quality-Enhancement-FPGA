...
HD_PWD='E:/SineCalculate/2.Firmware/dds_lut/dds_lut.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dds_lut_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dds_lut_top.tcl
