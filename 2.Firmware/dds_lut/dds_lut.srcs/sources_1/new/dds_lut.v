...
// Tool Versions: 
// Description: 
// This module generates a complete sine wave by using a 1/4 cycle sine table
// stored in ROM and then constructing the full sine wave output.
// 
// Dependencies: 
// 
// Revision:
...
module dds_lut (
    ...
    rom_sin_1_4 rom_sin_1_4_inst_sin (
        ...
        .addra(phase_input),  // input wire [11 : 0] addra
        .douta(rom_out),      // output wire [13 : 0] douta
        .clkb (clk),          // input wire clkb
        .addrb(),             // input wire [11 : 0] addrb
        .doutb()              // output wire [13 : 0] doutb
    );
