...
HD_PWD='E:/SineCalculate/2.Firmware/SineCalculate/SineCalculate.runs/rom_sin_1_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_sin_1_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_sin_1_4.tcl
