...
HD_PWD='E:/SineCalculate/2.Firmware/SineCalculate/SineCalculate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sine_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sine_top.tcl -notrace
