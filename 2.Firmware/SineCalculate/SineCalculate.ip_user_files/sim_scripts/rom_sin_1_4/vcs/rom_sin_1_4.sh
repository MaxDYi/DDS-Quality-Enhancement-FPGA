...
#
# Script generated by Vivado on Fri Nov 15 12:42:19 +0800 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : rom_sin_1_4.sh
...
#
# Usage        : rom_sin_1_4.sh
#                rom_sin_1_4.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                rom_sin_1_4.sh [-reset_run]
#                rom_sin_1_4.sh [-reset_log]
#                rom_sin_1_4.sh [-help]
#
...
#                script (type 'rom_sin_1_4.sh -help' for more information).
#
...
# script info
echo -e "rom_sin_1_4.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./rom_sin_1_4.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.rom_sin_1_4 xil_defaultlib.glbl -o rom_sin_1_4_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./rom_sin_1_4_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key rom_sin_1_4_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc rom_sin_1_4_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./rom_sin_1_4.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: rom_sin_1_4.sh [-help]\n\
Usage: rom_sin_1_4.sh [-step]\n\
Usage: rom_sin_1_4.sh [-lib_map_path]\n\
Usage: rom_sin_1_4.sh [-reset_run]\n\
Usage: rom_sin_1_4.sh [-reset_log]\n\
Usage: rom_sin_1_4.sh [-keep_index]\n\
Usage: rom_sin_1_4.sh [-noclean_files]\n\n\
