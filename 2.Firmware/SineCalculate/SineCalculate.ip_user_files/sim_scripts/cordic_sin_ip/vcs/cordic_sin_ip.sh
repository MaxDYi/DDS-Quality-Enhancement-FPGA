...
#
# Script generated by Vivado on Mon Dec 02 20:15:28 +0800 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : cordic_sin_ip.sh
...
#
# Usage        : cordic_sin_ip.sh
#                cordic_sin_ip.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cordic_sin_ip.sh [-reset_run]
#                cordic_sin_ip.sh [-reset_log]
#                cordic_sin_ip.sh [-help]
#
...
#                script (type 'cordic_sin_ip.sh -help' for more information).
#
...
# script info
echo -e "cordic_sin_ip.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cordic_sin_ip.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.cordic_sin_ip xil_defaultlib.glbl -o cordic_sin_ip_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./cordic_sin_ip_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key cordic_sin_ip_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc cordic_sin_ip_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cordic_sin_ip.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cordic_sin_ip.sh [-help]\n\
Usage: cordic_sin_ip.sh [-step]\n\
Usage: cordic_sin_ip.sh [-lib_map_path]\n\
Usage: cordic_sin_ip.sh [-reset_run]\n\
Usage: cordic_sin_ip.sh [-reset_log]\n\
Usage: cordic_sin_ip.sh [-keep_index]\n\
Usage: cordic_sin_ip.sh [-noclean_files]\n\n\
