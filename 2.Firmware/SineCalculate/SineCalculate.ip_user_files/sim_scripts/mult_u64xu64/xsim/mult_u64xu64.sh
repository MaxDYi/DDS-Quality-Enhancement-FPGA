...
#
# Script generated by Vivado on Mon Nov 11 21:35:04 +0800 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : mult_u64xu64.sh
...
#
# Usage        : mult_u64xu64.sh
#                mult_u64xu64.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mult_u64xu64.sh [-reset_run]
#                mult_u64xu64.sh [-reset_log]
#                mult_u64xu64.sh [-help]
#
...
# script info
echo -e "mult_u64xu64.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mult_u64xu64.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_13 -L xbip_pipe_v3_0_9 -L xbip_bram18k_v3_0_9 -L mult_gen_v12_0_21 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mult_u64xu64 xil_defaultlib.mult_u64xu64 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mult_u64xu64 -key {Behavioral:sim_1:Functional:mult_u64xu64} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mult_u64xu64.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mult_u64xu64.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mult_u64xu64.sh [-help]\n\
Usage: mult_u64xu64.sh [-step]\n\
Usage: mult_u64xu64.sh [-lib_map_path]\n\
Usage: mult_u64xu64.sh [-reset_run]\n\
Usage: mult_u64xu64.sh [-reset_log]\n\
Usage: mult_u64xu64.sh [-keep_index]\n\
Usage: mult_u64xu64.sh [-noclean_files]\n\n\
