...
#                script (type 'mult_u64xu64.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.mult_u64xu64 xil_defaultlib.glbl -o mult_u64xu64_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./mult_u64xu64_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key mult_u64xu64_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc mult_u64xu64_simv.daidir vcs_lib c.obj)
